...
resource "aws_security_group" "bastion_ssh_all_sg_sumanth" {
    
    name            = "bastion_ssh_all_sg_sumanth"
    description     = "Allow SSH from Anywhere"
    vpc_id          = aws_vpc.vpcsumanth.id #module.site.output_vpc_id 
    ...
    Name            = "Bastion Allow All_sumanth"
    }
...
output "output_bastion_ssh" {
  value = aws_security_group.bastion_ssh_all_sg_sumanth.id
}
...
resource "aws_security_group" "bastion_ssh_from_nat" {
    ...
    ingress {
     ...
     protocol        = "tcp"
     security_groups = [
                        aws_security_group.bastion_ssh_all_sg_sumanth.id,
